...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void addGame(Game game) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(KEY_LOCATION, (game.getLocation()).toString());
        values.put(KEY_DATE, (game.getDate()).toString());
        values.put(KEY_CAPACITY, game.getSize());
    ...
    public Location getLocation(String name) {
        ...
        Location location = new Location(cursor.getString(0),
                cursor.getString(1), Integer.parseInt(cursor.getString(4)), cursor.getString(3), cursor.getString(2));
        return location;
    }
}
