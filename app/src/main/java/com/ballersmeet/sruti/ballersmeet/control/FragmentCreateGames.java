...
public class FragmentCreateGames extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RelativeLayout rlLayout = (RelativeLayout) inflater.inflate(R.layout.fragment_create_games, container, false);
